' MacroName: Convert to Unauthenticated RDA
' MacroDescription: Converts an existing record into a core level RDA record
' with additional RDA Fields.
